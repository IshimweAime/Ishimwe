...
class Follower:
	def __init__(self):
		...
		self.switchMode= rospy.get_param('~switchMode') # if this is set to False the O button has to be kept pressed in order for it to move 如果设置为false，必须按住0才移动
...
class simplePID:
	...
	def __init__(self, target, P, I, D):
		...
		# check if parameter shapes are compatabile. 检查参数是否兼容
